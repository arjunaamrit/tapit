...
export const EnhancedDocumentViewer = ({
  ...
  return (
    <>
      <div
        ref={containerRef}
        className="reader-card w-full flex-1 rounded-none shadow-none p-4 sm:rounded-xl sm:shadow-lg sm:p-6 md:p-8 lg:p-10 min-h-0 reader-prose select-text cursor-text"
